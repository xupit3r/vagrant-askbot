...
DATABASES = {
    'default': {
        ...
        'USER': 'ab',                      # Not used with sqlite3.
        'PASSWORD': 'ab',                  # Not used with sqlite3.
...
SECRET_KEY = '540d5327b7c880f089b7bb2759fa4662'
...
STATICFILES_DIRS = (
    ...
    ('myskin', ASKBOT_EXTRA_SKINS_DIR),
    ('myskin/media', os.path.join(ASKBOT_EXTRA_SKINS_DIR, 'myskin/media'))
)
STATICFILES_FINDERS = (
